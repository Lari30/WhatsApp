...
import com.larisantos.whatsapp.databinding.ActivityPerfilBinding
...
class PerfilActivity : AppCompatActivity() {
    ...
    private fun uploadImagemStorage(uri: Uri) {
        ...
        firebaseAuth.currentUser?.uid?.let {  idUsuario ->
    ...
    private fun solicitarPermissoes() {
        ...
        if ( listaPermissoesNegadas.isNotEmpty()){
            ...
            val gerenciadorPermissoes = registerForActivityResult(
                ...
                temPermissaoCamera = permissoes.getOrDefault(Manifest.permission.CAMERA, temPermissaoCamera)

                temPermissaoGaleria = permissoes.getOrDefault(Manifest.permission.READ_EXTERNAL_STORAGE,temPermissaoGaleria)
